...
"""
from sqlalchemy import Column, String, Integer, Boolean, DateTime, Text, ForeignKey, Float, Index
...
class AIUsageLog(Base):
    ...
    estimated_cost = Column(Float(precision=6), nullable=False, default=0.0)  # USD with 6 decimal places
