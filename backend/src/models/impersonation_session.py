...
class ImpersonationSession(Base):
    ...
    # Relationships
    admin = relationship("User", foreign_keys=[admin_id], backref="impersonation_sessions_as_admin")
    target_user = relationship("User", foreign_keys=[target_user_id], backref="impersonation_sessions_as_target")
    
    # Indexes for performance
    __table_args__ = (
        # Ensure only one active session per admin
        Index('idx_active_admin_session', admin_id, 
