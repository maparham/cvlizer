...
class OptimizationHistory(Base):
    ...
    optimization_type = Column(String(50), default="ats", nullable=False)  # "ats", "job_fit", "content_enhancement"
    ...
    missing_keywords = Column(JSON, nullable=True)  # List of missing keywords with metadata
    ...
    job_description = relationship("JobDescription", back_populates="optimization_history")
