...
class User(Base):
    ...
    content_enhancements = relationship("ContentEnhancement", back_populates="user", cascade="all, delete-orphan")
    ai_enhancements = relationship("AIEnhancement", back_populates="user", cascade="all, delete-orphan")
