...
- MINIMALITY RULE: In `html_diff`, include only the lines or sentences that contain changes. Omit unchanged lines and paragraphs entirely. Within each included line/sentence, keep its full text as context. Wrap only the changed tokens in <del>/<ins>. Examples:
