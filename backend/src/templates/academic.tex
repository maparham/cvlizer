...
% Academic font settings - elegant serif fonts (Computer Modern)
...
% Academic section hierarchy - elegant scholarly styling
...
% Better spacing for itemize - academic style
\setlist[itemize]{topsep=0pt, itemsep=0pt, parsep=0pt, partopsep=0pt, leftmargin=*}
\pagenumbering{gobble}

% Academic paragraph spacing - moderate spacing for readability
