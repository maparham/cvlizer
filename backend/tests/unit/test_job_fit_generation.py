...
class TestGenerateJobFitSync:
    ...
    def test_generate_job_fit_sync_success_with_required_fields(self, mock_analyze, mock_session_local):
    ...
    @patch('src.api.ai.SessionLocal')
    @patch('src.services.ai_service.analyze_job_fit_sync')
    def test_generate_job_fit_sync_missing_confidence_score(self, mock_analyze, mock_session_local):
    ...
    @patch('src.api.ai.SessionLocal')
    @patch('src.services.ai_service.analyze_job_fit_sync')
    def test_generate_job_fit_sync_missing_generated_at(self, mock_analyze, mock_session_local):
    ...
    @patch('src.api.ai.SessionLocal')
    @patch('src.services.ai_service.analyze_job_fit_sync')
    def test_generate_job_fit_sync_exception_handling(self, mock_analyze, mock_session_local):
