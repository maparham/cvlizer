...
describe("ImpersonationService", () => {
  ...
  describe("startImpersonation", () => {
    ...
    it("should handle 403 Forbidden error", async () => {
      ...
      try {
        ...
        expect((error as ImpersonationError).message).toBe(
  ...
  describe("endImpersonation", () => {
    ...
    it("should handle other API errors", async () => {
      ...
      await expect(impersonationService.endImpersonation()).rejects.toThrow(
        ImpersonationError,
      );
  ...
  describe("getActiveSessions", () => {
    ...
    it("should handle API error", async () => {
      ...
      await expect(impersonationService.getActiveSessions()).rejects.toThrow(
        ImpersonationError,
      );
  ...
  describe("revokeSession", () => {
    ...
    it("should handle 404 Not Found error", async () => {
      ...
      await expect(
        impersonationService.revokeSession("nonexistent-session"),
      ).rejects.toThrow(ImpersonationError);
    ...
    it("should handle other API errors", async () => {
      ...
      await expect(
        impersonationService.revokeSession("session-123"),
      ).rejects.toThrow(ImpersonationError);
