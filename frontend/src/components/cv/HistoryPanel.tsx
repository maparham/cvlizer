  ...
  return (
    ...
    >
      <Box sx={{ display: "flex", flexDirection: "column", height: "100%" }}>
        ...
        <Box sx={{ px: 2, pb: 1 }}>
          <Typography variant="caption" color="text.secondary">
            Only the most recent 50 versions are kept. The original version is
            always preserved.
          </Typography>
        </Box>
                        ...
                        <ListItemSecondaryAction>
                          <Box sx={{ display: "flex", gap: 0.5 }}>
                            ...
                            {index > 0 && !entry.isInitial && (
                              <Tooltip
                                title={`Delete this version${entry.label ? ` (${entry.label})` : ""}`}
                              >
                                <span>
                                  <IconButton
                                    size="small"
                              ...
                              >
                                <span>
                                  <IconButton
                                    ...
                                    disabled={state.loading}
                                    color={
                                      entry.isInitial ? "warning" : "default"
                                    }
                                  >
      ...
      >
        ...
        <DialogContent>
          ...
          <TextField
            ...
            onChange={(e) =>
              updateState({ snapshotDescription: e.target.value })
            }
      ...
      >
        ...
        <DialogContent>
          <Alert
            severity={state.selectedEntry?.isInitial ? "info" : "warning"}
            sx={{ mb: 2 }}
          >
            {state.selectedEntry?.isInitial
          ...
          {state.selectedEntry && (
            <Box>
              <Typography variant="body2" gutterBottom>
                ...
                {state.selectedEntry.label || state.selectedEntry.description}
              </Typography>
              <Typography variant="caption" color="text.secondary">
