...
import {
  ...
  DiffChange,
} from "../../services/backendHistoryService";
...
const SimpleCVDiffViewer: React.FC<SimpleCVDiffViewerProps> = ({
  ...
  if (changes.length === 0) {
    return (
      <Alert severity="info">No changes detected between these versions.</Alert>
    );
  }
                    ...
                    {change.text_diff && (
                      <Box sx={{ mt: 2 }}>
                        ...
                        >
                          ...
                          change.text_diff.stats.deletions > 0
                          ...
                          <Box sx={{ mt: 1 }}>
                            ...
                            <Box
                              ...
                              dangerouslySetInnerHTML={{
                                __html: change.text_diff.inline_diff,
                              }}
                            />
                          </Box>
                        ) : (
                        ...
                        {/* Word-level Summary */}
                        {change.text_diff.word_diff &&
                          change.text_diff.word_diff.length > 0 && (
                            <Box sx={{ mt: 2 }}>
                              <Typography
                                variant="caption"
                                sx={{
                              ...
                              {change.text_diff.word_diff.map(
                                (wordChange, idx) => (
                                  <Typography
                                    key={idx}
                                    variant="body2"
