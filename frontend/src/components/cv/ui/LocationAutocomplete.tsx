...
const COMMON_LOCATIONS = [
  ...
  'Amsterdam, Netherlands', 'Vienna, Austria', 'Zurich, Switzerland', 'Munich, Germany',
  'Hamburg, Germany', 'Frankfurt, Germany', 'Cologne, Germany', 'Stuttgart, Germany',
  'Düsseldorf, Germany', 'Brussels, Belgium', 'Dublin, Ireland', 'Copenhagen, Denmark',
  'Stockholm, Sweden', 'Oslo, Norway', 'Helsinki, Finland', 'Prague, Czech Republic',
  'Warsaw, Poland', 'Budapest, Hungary', 'Bucharest, Romania', 'Sofia, Bulgaria',
  'Athens, Greece', 'Lisbon, Portugal', 'Barcelona, Spain', 'Milan, Italy',
  'Naples, Italy', 'Turin, Italy', 'Florence, Italy', 'Venice, Italy', 'Bologna, Italy',
  'Moscow, Russia', 'Saint Petersburg, Russia', 'Kiev, Ukraine', 'Minsk, Belarus',

  // Asian Cities
  'Tokyo, Japan', 'Osaka, Japan', 'Kyoto, Japan', 'Yokohama, Japan', 'Nagoya, Japan',
  'Seoul, South Korea', 'Busan, South Korea', 'Incheon, South Korea', 'Shanghai, China',
  'Beijing, China', 'Guangzhou, China', 'Shenzhen, China', 'Hong Kong', 'Taipei, Taiwan',
  'Singapore', 'Bangkok, Thailand', 'Jakarta, Indonesia', 'Kuala Lumpur, Malaysia',
  'Manila, Philippines', 'Ho Chi Minh City, Vietnam', 'Hanoi, Vietnam', 'Mumbai, India',
  'Delhi, India', 'Bangalore, India', 'Chennai, India', 'Kolkata, India', 'Hyderabad, India',
  'Pune, India', 'Ahmedabad, India', 'Jaipur, India', 'Lucknow, India', 'Kanpur, India',
  ...
  'Hamilton, Canada', 'Kitchener, Canada', 'Mexico City, Mexico', 'Guadalajara, Mexico',
  'Monterrey, Mexico', 'Puebla, Mexico', 'Tijuana, Mexico', 'León, Mexico',

  // South American Cities
  'São Paulo, Brazil', 'Rio de Janeiro, Brazil', 'Brasília, Brazil', 'Buenos Aires, Argentina',
  'Córdoba, Argentina', 'Rosario, Argentina', 'Lima, Peru', 'Bogotá, Colombia',
  'Medellín, Colombia', 'Santiago, Chile', 'Caracas, Venezuela', 'Quito, Ecuador',
  'Montevideo, Uruguay', 'Asunción, Paraguay', 'La Paz, Bolivia',

  // Australian & Oceania
  'Sydney, Australia', 'Melbourne, Australia', 'Brisbane, Australia', 'Perth, Australia',
  'Adelaide, Australia', 'Gold Coast, Australia', 'Newcastle, Australia', 'Auckland, New Zealand',
  'Wellington, New Zealand', 'Christchurch, New Zealand',

  // Remote/Other
  'Remote', 'Remote Work', 'Work from Home', 'Hybrid', 'Flexible Location', 'Anywhere'
]
...
const LocationAutocomplete: React.FC<LocationAutocompleteProps> = ({
  ...
  const handleInputChange = (_event: any, newInputValue: string) => {
    ...
    const exactMatch = COMMON_LOCATIONS.find(location =>
