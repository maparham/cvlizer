...
const studentTemplate: CVTemplate = {
  ...
  description: 'Perfect for students, recent graduates, and entry-level positions',
  sections: ['Education', 'Projects', 'Internships', 'Volunteer Work', 'Skills'],
  sampleData: {
    personal_info: {
    ...
    professional_summary: {
      content: "Motivated student with strong academic background and hands-on project experience. Seeking opportunities to apply technical skills and contribute to innovative projects.",
      keywords: ["Student", "Recent Graduate", "Eager to Learn", "Project Experience"]
    },
    education: [
      {
        id: "edu-1",
...
const professionalTemplate: CVTemplate = {
  ...
  sampleData: {
    ...
    professional_summary: {
      content: "Experienced professional with 5+ years in [Industry]. Proven track record of delivering results and leading cross-functional teams. Strong expertise in [Key Skills].",
      keywords: ["Experienced", "Results-Driven", "Team Leadership", "Industry Expertise"]
    },
    work_experience: [
      {
        id: "work-1",
        ...
        end_date: "",
        current: true,
        description: "Lead development of key projects and mentor junior team members",
        achievements: [
...
const executiveTemplate: CVTemplate = {
  ...
  sections: ['Professional Summary', 'Work Experience', 'Leadership Roles', 'Education'],
  sampleData: {
    personal_info: {
      full_name: "Your Full Name",
      email: "your.email@company.com",
    ...
    professional_summary: {
      content: "Visionary executive with 15+ years of experience driving organizational growth and transformation. Proven track record of building high-performing teams and delivering strategic initiatives that generate significant business value.",
      keywords: ["Strategic Leadership", "Organizational Growth", "Team Building", "Business Transformation"]
    },
    work_experience: [
      {
        id: "work-1",
        ...
        end_date: "",
        current: true,
        description: "Lead technology strategy and digital transformation initiatives across the organization",
        achievements: [
        ...
        technologies: ["Strategic Planning", "Team Leadership", "Digital Transformation"]
      },
      {
        id: "work-2",
        company: "Previous Company",
        ...
        technologies: ["Engineering Management", "Product Strategy", "Team Development"]
      }
    ],
    skills: {
      technical: ["Strategic Planning", "Team Leadership", "Digital Transformation", "Product Strategy"],
      soft: ["Executive Communication", "Change Management", "Stakeholder Management"],
      languages: [
        { id: "lang-1", language: "English", proficiency: "Native" }
      ]
    },
