  ...
  >
    ...
    >
      ...
      <p style={{ color: "#666", marginBottom: "1rem" }}>
        Missing or invalid Clerk Publishable Key. Please check your environment
        configuration.
      </p>
      <p style={{ color: "#888", fontSize: "0.9rem" }}>
        Set VITE_CLERK_PUBLISHABLE_KEY in your .env.local file with a valid
...
if (!PUBLISHABLE_KEY) {
  console.error(
    "Missing Clerk Publishable Key - VITE_CLERK_PUBLISHABLE_KEY not set",
  );
