        ...
        {showAIAttribution !== undefined && (
          <Box sx={{ mb: 3 }}>
            <FormControlLabel
              ...
              label="Credit rahkar.pro on this CV"
            />
            <Typography variant="body2" color="text.secondary">
              Adds &ldquo;Generated by rahkar.pro&rdquo; at the bottom of your exported CV.
              Turn it off to export without the note.
            </Typography>
          </Box>
        )}
