    ...
    suggestions: [
      {
        ...
        suggested: 'Senior Software Engineer with 5+ years of experience developing scalable web applications using modern technologies.',
    ...
    suggestions: [
      {
        ...
        suggested: 'Led development of web applications serving 10,000+ users, resulting in 30% increase in user engagement',
